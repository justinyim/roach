...
def writeFileHeader(dataFileName, params, manParams):
    ...
    fileout.write('time (us), Tail Pos., Femur Pos., Motor Pos., Att 1 (pitch), Att 2 (roll), Att 3 (yaw), Att. 4, Cmd Motor DC, Tail DC, Front Prop DC, Rear Prop DC, BLDC DC, GyroX, GryoY, GryoZ, AX ,AY ,AZ, State, Additional data \n')
    fileout.close()
