...
model(2).f_spring = @(x,w) (x.*3.836493898315605e-1+x.^2.*2.9279712493158e-2).*(1 - 0.13*max(min(-30*w,1),-1));
...
model(3).f_spring = @(x,w) (x.*3.759274976416161e-1+x.^2.*4.275050419811049e-2).*(1 - 0.18*max(min(-30*w,1),-1));